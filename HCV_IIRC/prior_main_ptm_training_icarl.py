...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default="isic_2019",
                        choices=["incremental_cifar100", "iirc_cifar100", "incremental_imagenet_full",
                                 "incremental_imagenet_lite", "iirc_imagenet_full", "iirc_imagenet_lite", "isic_2019"])
    ...
    parser.add_argument('--dataset_path', type=str, default="./ISIC_2019")
    ...
    # The training method  ###############################################
    parser.add_argument('--method', type=str, default="icarl_cnn_ptm",choices=["icarl_cnn_ptm", "learning_without_forgetting_ptm"])
    ################################################################################
